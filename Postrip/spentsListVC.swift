...
class spentsListVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UINavigationControllerDelegate {
    ...
    @IBOutlet weak var spentsTV: UITableView!
    ...
    override func viewDidLoad() {
        ...
        // allow constraints
        spentsTV.translatesAutoresizingMaskIntoConstraints = false
        ...
        self.view.addConstraints(NSLayoutConstraint.constraints(
            ...
            options: [],
            metrics: nil, views: ["tableview":spentsTV]))
        ...
        spentsTV.delegate = self
        spentsTV.dataSource = self
