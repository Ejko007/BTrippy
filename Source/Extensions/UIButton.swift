...
extension UIButton {
    ...
    static func thumbnailsButton() -> UIButton {
        ...
        let button = UIButton(frame: CGRect(origin: CGPoint.zero, size: CGSize(width: 100, height: 55)))
    ...
    static func deleteButton() -> UIButton {
        ...
        // button.setImage(UIImage(named: "recycle_bin"), for: .normal)
        // button.setImage(UIImage(named: "recycle_bin")?.withRenderingMode(.alwaysOriginal), for: .normal)
